...
import stylesCss from 'themes/doctorstrange/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_doctorstrange_componentCss']) {
    
    document['_vaadintheme_doctorstrange_componentCss'] = true;
  }
